...
$('#print').on('click', printThis);
$('#verify').on('click', verifyThis);
$('#lookup').on('click', lookupThis);
$('#add').on('click', addThis);
$('#contains').on('click', containsThis);
$('#update').on('click', updateThis);
